...
public class BotMoveThread extends Thread {
	...
	public BotMoveThread(Bot bot, GameController controller, Algorithm algorithm) {
	...
	public void run() {
		...
		Point[] move = this.algorithm.returnBestMove(new GameState(this.controller.getController().getGame(), null, null), this.bot);
