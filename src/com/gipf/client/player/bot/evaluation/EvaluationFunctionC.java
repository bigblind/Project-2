...
//		System.out.println("calculating for player: " + player.getStoneColor());
//		System.out.println("white : " + game.getPlayerOne().getStoneAccount() + " black: " + game.getPlayerTwo().getStoneAccount());
//		System.out.println();
